...
const guestLogin = asyncHandler(async (req, res) => {
  const GUEST_EMAIL = "guestuser10@gmail.com";
  const GUEST_USERNAME = "guestuser10";
  const GUEST_PASSWORD = "Guest@12345";

  // Find the guest account, or create it the first time anyone clicks
  // "Continue as Guest" - this means you never have to manually seed
  // it into the database yourself.
